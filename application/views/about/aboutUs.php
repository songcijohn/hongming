<section id="main-container">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 heading text-center">
                <h2 class="title2">成都宏明电子股份有限公司
                    <span class="title-desc">电子元件先锋 国防工业基石</span>
                </h2>
            </div>
        </div><!-- Title row end -->
        ...
        <div class="row about-wrapper-top">
            <div class="col-md-6 ts-padding about-message">
                <h3>宏明基地</h3>
                <p>公司拥有1个省级技术中心，1个国家级计量检测站、两个主要控股公司。</p>
                <ul class="unstyled arrow">
                    <li><a href="#">生产基地分别位于国家成都经济技术开发区（龙泉驿区）和青羊区蛟龙工业港，主要从事阻容元件和滤波器件的研制、生产和销售；</a></li>
    ...
    <div class="container"><!-- 2nd container start -->
        ...
        <div class="team">
            ...
            <div class="row">
                <div class="col-md-12 heading text-center">
                    <h2 class="title2">集团成员
                        <span class="title-desc">主要成员公司</span>
                    </h2>
                </div>
            </div><!-- Title row end -->
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="team wow slideInLeft">
                        <div class="img-hexagon">
                            <img src="/public/images/team/team2.jpg" alt="">
                            <span class="img-top"></span>
                            <span class="img-bottom"></span>
                        </div>
                        <div class="team-content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="team wow slideInRight">
                        <div class="img-hexagon">
                            <img src="/public/images/team/team3.jpg" alt="">
                            <span class="img-top"></span>
                            <span class="img-bottom"></span>
                        </div>
                        <div class="team-content">
