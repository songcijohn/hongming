				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<div class="panel-group" id="accordionA">
			                ...
			                <div id="collapseOne" class="panel-collapse collapse in">
			                  <div class="panel-body">
			                    <ul class="unstyled arrow">
									<li>本科及以上学历</li>
									<li>2年及以上工作经历</li>
									<li>负责连接器、位移传感器、滤波器、有机电容、高压电容等新产品设计、开发任务</li>
									<li>负责技术文件的编制、修订工作</li>
									<li>负责新产品销售的技术支持工作</li>
								</ul>
			                  </div>
			                </div>
		              	</div><!--/ Panel 1 end-->
		              	...
		              	<div class="panel panel-default">
			                <div class="panel-heading">
				                <h4 class="panel-title">
				                	<a data-toggle="collapse" class="collapsed" data-parent="#accordionA, #accordionB" href="#collapseTwo">岗位职责</a>
				            	</h4>
			                </div>
		              	...
		              	<div class="panel panel-default">
			                <div class="panel-heading">
				                <h4 class="panel-title">
				                	<a data-toggle="collapse" class="collapsed" data-parent="#accordionA, #accordionB" href="#collapseThree">岗位待遇</a>
				            	</h4>
			                </div>
		   		...
		   		<h3 class="title-border">工艺师</h3>
					...
					<div class="panel-group" id="accordionB">
		              	...
		              	<div class="panel panel-default">
			                <div class="panel-heading">
				                <h4 class="panel-title">
				                	<a data-toggle="collapse" class="collapsed" data-parent="#accordionA, #accordionB" href="#collapseB">岗位职责</a>
				            	</h4>
			                </div>
		              	...
		              	<div class="panel panel-default">
			                <div class="panel-heading">
				                <h4 class="panel-title">
				                	<a data-toggle="collapse" class="collapsed" data-parent="#accordionA, #accordionB" href="#collapseC">岗位待遇</a>
				            	</h4>
			                </div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="sidebar sidebar-right">
						...
						<div class="widget widget-categories">
							<h3>申请方式</h3>
							<p>请将个人简历发送至rzb@chinahongming.com，我们会尽快与您联系！</p>
						</div><!-- category end -->

						<!-- tags start -->
						<div class="widget widget-tags">
							<h3>为何选择我们</h3>
							<p>公司不仅快速发展的过程中，也为员工提供有竞争力的薪资福利及各种形式的培训，以高速成长的业绩为每一位员工撑起个人职业发展的广阔空间。</p>
							<p>诚邀各界英才加盟我们的行列！</p>
						</div><!-- tags end -->
